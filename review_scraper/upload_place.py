...
if os.path.isfile(already_processed_places_file_name):#if the file exists
    print "found " + already_processed_places_file_name
...
try:
        ...
        for num in range(len(data)):
            ...
            try: #upload place
                ...
                if e.getcode() == 500 or e.getcode() == 400:
                    response = e.read()
                    if 'null' not in response[30:]:# skip the first null, only check the reason field
    ...
    print "saving " + already_processed_places_file_name
